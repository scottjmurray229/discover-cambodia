...
- **Title format:** "[Destination/Topic] Travel Guide 2026 | Discover Cambodia"
...
- **Author pages:** Person schema for Scott (/about/scott)
...
| Expertise | Include real prices in USD, transport details, specific hotel names |
| Authority | Byline: "Scott Murray", link to /about/scott author page |
| Trust | Real data from verified trips, FTC-compliant affiliate disclosure |

## Image Requirements

- All images must have descriptive alt text (not just "temple" — use "Angkor Wat reflected in the moat at sunrise, Siem Reap")
