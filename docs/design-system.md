...
Each destination theme uses a CSS custom property gradient for hero overlays, ImmersiveBreak sections, and card accents.

| Theme Name | CSS Custom Property | CSS Gradient | Mood |
|------------|-------------------|-------------|------|
| Angkor | `--gradient-angkor` | `linear-gradient(160deg, #1a1035 0%, #2d1b69 30%, #4C1D95 55%, #3730A3 80%, #1e1145 100%)` | Purple/mystic |
| Mekong | `--gradient-mekong` | `linear-gradient(135deg, #0E4D5C, #0D7377, #14B8A6)` | Teal/ocean |
| Tonle Sap | `--gradient-tonlesap` | `linear-gradient(135deg, #065F46, #059669, #34D399)` | Green/nature |
| Kratie | `--gradient-kratie` | `linear-gradient(135deg, #92400E, #D97706, #FBBF24)` | Gold/heritage |
| Kampot | `--gradient-kampot` | `linear-gradient(135deg, #064E3B, #0D7377, #06B6D4)` | Teal-blue/lagoon |
| Koh Rong | `--gradient-kohrong` | `linear-gradient(135deg, #9D174D, #E8654A, #FB923C)` | Coral-sunset |
| Mondulkiri | `--gradient-mondulkiri` | `linear-gradient(135deg, #0E7490, #14B8A6, #5EEAD4)` | Surf-teal |
| Battambang | `--gradient-battambang` | `linear-gradient(160deg, #451a03 0%, #78350F 30%, #B45309 55%, #D97706 80%, #92400E 100%)` | Gold/amber |
