      ...
      {section === 'auto' && (
        <>
          ...
          {[
            ...
            { icon: '💱', title: 'Currency Rates', freq: 'Every 12 hours', detail: 'USD/KHR rate for budget tracker' },
        ...
        <>
          ...
          <div style={{
            ...
            <div style={{
              ...
              "I use SafetyWing for every trip and thankfully I've never had to actually use it, but having it is peace of mind." — Scott
            </div>
