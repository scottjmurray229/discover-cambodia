...
essentials:
  - icon: "🌡️"
    label: "Climate"
    value: "Tropical coastal, 27-33°C, wet season Jun-Oct"
  - icon: "💵"
    label: "Currency"
    value: "USD accepted everywhere"
  - icon: "🏖️"
    label: "Best Beach"
    value: "Otres Beach (quieter, less developed)"
  - icon: "⛴️"
    label: "Island Boats"
    value: "Speed ferries to Koh Rong from $12"
  - icon: "📶"
    label: "WiFi"
    value: "Variable — strong in Otres, patchy elsewhere"
  - icon: "🏧"
    label: "ATMs"
    value: "Available on main roads, limited on islands"
  - icon: "⏰"
    label: "Time Zone"
    value: "GMT+7"
  - icon: "🚌"
    label: "From Phnom Penh"
    value: "4-5 hours by bus ($8-12)"
highlights:
  - "Otres Beach — the local favorite"
  - "Island hopping to Koh Rong and Koh Rong Sanloem"
  - "Ream National Park boat tours"
...
relatedDestinations:
  ...
  - "kep"
faqItems:
  - question: "Has Sihanoukville been ruined by Chinese development?"
    answer: "The downtown area and Ochheuteal Beach have been dramatically transformed by Chinese-funded casino and hotel construction. Much of what backpackers remember from the 2010s is gone. However, Otres Beach (2 km south) remains relatively untouched, Ream National Park is still beautiful, and Sihanoukville functions perfectly well as a transit hub for the islands. The town is honestly best treated as a launching pad for Koh Rong and Koh Rong Sanloem."
  - question: "Is Sihanoukville safe in 2026?"
    answer: "Otres Beach and the tourist areas around the ferry pier are safe. The downtown casino district can feel intimidating at night due to the scale of construction and security presence — I would avoid wandering there after dark. Scams targeting tourists are more common here than elsewhere in Cambodia, so agree on tuk-tuk prices before getting in and be cautious of overly friendly strangers near the casinos."
  - question: "Should I skip Sihanoukville and go straight to the islands?"
    answer: "If your goal is beaches and island life, yes — book a bus from Phnom Penh that connects with the ferry schedule and head straight to Koh Rong or Koh Rong Sanloem. If you want to explore Ream National Park or enjoy the Otres Beach vibe, spend one or two nights. Sihanoukville is not a destination to linger in anymore, but Otres has a charm that justifies a stop."
  - question: "How do I get to Koh Rong from Sihanoukville?"
...
affiliatePicks:
  ...
  - name: "Koh Rong Island Hopping Day Trip"
    type: "tour"
    price: "$25-40"
    personalNote: "A full-day boat trip hitting three snorkeling spots and a beach lunch on a deserted island. The coral at the second stop was the healthiest I saw in Cambodia."
    affiliateUrl: "https://www.getyourguide.com/sihanoukville?partner_id=IVN6IQ3"
  - name: "Ream National Park Boat Tour"
    type: "activity"
    price: "$20-30"
    personalNote: "A half-day tour through mangrove channels into the national park. Saw monkeys, eagles, and a dolphin. The beach stop for swimming in transparent water was the surprise highlight."
    affiliateUrl: "https://www.viator.com/sihanoukville?pid=P00290009"
  - name: "Mushroom Point Bungalows"
    type: "hotel"
    price: "$12-25/night"
