...
essentials:
  - icon: "🌡️"
    label: "Climate"
    value: "Tropical, 25-36°C, dry Nov-Apr"
  - icon: "💵"
    label: "Currency"
    value: "USD accepted, Riel common for small purchases"
  - icon: "🐬"
    label: "Famous For"
    value: "Irrawaddy freshwater dolphins"
  - icon: "🏝️"
    label: "Must-Visit"
    value: "Koh Trong island by bicycle"
  - icon: "🏧"
    label: "ATMs"
    value: "Limited — ABA and ACLEDA on main street"
  - icon: "📶"
    label: "WiFi"
    value: "Available in town, weak on Koh Trong"
  - icon: "🌅"
    label: "Best View"
    value: "Mekong sunset from the riverside promenade"
  - icon: "⏱️"
    label: "Ideal Stay"
    value: "2-3 days"
highlights:
  - "Irrawaddy dolphin watching"
  - "Koh Trong island cycling"
...
relatedDestinations:
  ...
  - "battambang"
faqItems:
  - question: "Can I actually see dolphins in Kratie?"
    answer: "Yes. The Irrawaddy dolphins are seen consistently at Kampi, 15 km north of Kratie town. A boat trip ($9 for a private boat, or $7 per person shared) takes you to the deep-water pool where the dolphins live. Sightings are not guaranteed, but on the four trips I have made, I saw dolphins three times. They surface to breathe every few minutes, showing their rounded heads and dorsal fins. Early morning (6-7 AM) and late afternoon (4-5 PM) are the best viewing times."
  - question: "How many Irrawaddy dolphins are left?"
    answer: "As of 2025, the population in the Cambodian stretch of the Mekong was estimated at approximately 105 individuals — up from a low of around 80 in the 2010s, thanks to conservation efforts that banned gillnet fishing in critical habitat areas. They are critically endangered globally, and the Mekong population is the largest remaining freshwater group. Your boat fee includes a conservation contribution that funds patrol boats and monitoring programs."
  - question: "Is Kratie worth the long bus journey?"
    answer: "If you want to see an endangered species in the wild and experience rural Cambodia without a tourist infrastructure buffering the reality, yes. Kratie is not a conventional tourist destination — there are no night markets, no cooking classes, no Instagram-ready attractions. What it offers is a quiet Mekong town with crumbling colonial buildings, an island you can cycle around in an hour, and the chance to watch one of the world's rarest animals from a wooden boat. For me, that was more than enough."
  - question: "What is there to do in Kratie besides dolphins?"
...
affiliatePicks:
  ...
  - name: "Dolphin Watching Boat Tour"
    type: "tour"
    price: "$7-15"
    personalNote: "The boat ride to see the Irrawaddy dolphins was one of the most quietly profound wildlife experiences of my travels. Sitting in a wooden longboat on the brown Mekong, watching these critically endangered animals surface and breathe, I felt the weight of their rarity in a way no documentary can convey."
    affiliateUrl: "https://www.getyourguide.com/kratie?partner_id=IVN6IQ3"
  - name: "Koh Trong Homestay"
    type: "hotel"
