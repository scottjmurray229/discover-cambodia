...
essentials:
  - icon: "🌡️"
    label: "Climate"
    value: "Cooler highland, 18-30°C, pleasant year-round"
  - icon: "💵"
    label: "Currency"
    value: "USD accepted, Riel common, bring cash"
  - icon: "🐘"
    label: "Famous For"
    value: "Elephant Valley Project — ethical encounters"
  - icon: "🏞️"
    label: "Must-See"
    value: "Bou Sra waterfall — Cambodia's largest"
  - icon: "🌲"
    label: "Landscape"
    value: "Pine forests and rolling green hills"
  - icon: "🏧"
    label: "ATMs"
    value: "Limited — 1-2 in Sen Monorom (ABA)"
  - icon: "🏘️"
    label: "Indigenous Culture"
    value: "Bunong (Pnong) hill tribe communities"
  - icon: "⏱️"
    label: "Ideal Stay"
    value: "3-4 days"
highlights:
  - "Elephant Valley Project"
  - "Bou Sra waterfall hike"
...
relatedDestinations:
  ...
  - "siem-reap"
faqItems:
  - question: "Is the Elephant Valley Project ethical?"
    answer: "Yes — the Elephant Valley Project (EVP) is widely regarded as one of the most ethical elephant experiences in Southeast Asia. Elephants are not ridden, chained, or forced to perform. The project rescues elephants from logging and tourism operations, provides them with a forested habitat, and visitors observe the animals from a respectful distance as they roam freely. The day visit ($65) includes a trek through the forest to find the elephants, a river swim, and lunch. EVP is the gold standard for responsible elephant tourism."
  - question: "How hard is the journey to Mondulkiri?"
    answer: "The road from Phnom Penh to Sen Monorom (the provincial capital of Mondulkiri) is now fully paved and the 7-8 hour bus journey is uncomfortable but not difficult. The road quality has improved dramatically in recent years. The final stretch climbs into the highlands, and you will notice the temperature drop and the landscape change from flat paddies to rolling green hills. Budget buses ($10) are adequate; VIP buses ($12-15) with reclining seats are more comfortable for the long haul."
  - question: "What makes Mondulkiri different from the rest of Cambodia?"
    answer: "Mondulkiri feels like a different country. The elevation (800-900 meters) creates a cooler, fresher climate that is a dramatic relief from the lowland heat. The landscape shifts from paddies to pine forests, rolling grasslands, and dramatic waterfalls. The indigenous Bunong people have a distinct culture, language, and animist spiritual tradition that predates Cambodia's Buddhist majority. And the wildlife — elephants, gibbons, and forest birds — exists here in densities not found anywhere else in the country."
  - question: "Can I visit Bunong villages?"
...
affiliatePicks:
  - name: "Elephant Valley Project Day Visit"
    type: "activity"
    price: "$65"
    personalNote: "The most ethical elephant experience I have found in Southeast Asia. Walking through the forest to find rescued elephants roaming freely in their habitat, watching them bathe in the river, and eating lunch prepared by the Bunong staff — this was the highlight of my entire Cambodia trip. Do not ride elephants anywhere in Cambodia. Come here instead."
    affiliateUrl: "https://www.viator.com/mondulkiri?pid=P00290009"
    badge: "Must Do"
  - name: "Mayura Hill Hotel"
    type: "hotel"
    price: "$45-80/night"
  ...
  - name: "Mondulkiri Trekking & Waterfall Tour"
    type: "tour"
    price: "$25-40"
    personalNote: "A full-day guided trek through highland forest to Bou Sra waterfall and a Bunong village. The guide was a Bunong man who shared stories about traditional forest navigation and pointed out medicinal plants his grandmother used. The waterfall swimming hole at the end was the perfect reward."
    affiliateUrl: "https://www.getyourguide.com/mondulkiri?partner_id=IVN6IQ3"
  - name: "Bunong Homestay Experience"
    type: "hotel"
...
- **Getting There:** From Phnom Penh, buses to Sen Monorom take 7-8 hours ($10-12). The road is now fully paved and the journey, while long, is comfortable on VIP buses with reclining seats. Departure is early morning (6:30-7:00 AM) with arrival in early afternoon. From Kratie, the improved road cuts the journey to 4-5 hours ($10-12) via Snuol. There is no airport in Mondulkiri.
