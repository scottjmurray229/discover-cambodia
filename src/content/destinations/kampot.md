...
essentials:
  - icon: "🌡️"
    label: "Climate"
    value: "Tropical, 25-34°C, cooler near Bokor"
  - icon: "💵"
    label: "Currency"
    value: "USD accepted, Riel common locally"
  - icon: "🌶️"
    label: "Famous For"
    value: "Kampot pepper — world's finest"
  - icon: "🏔️"
    label: "Day Trip"
    value: "Bokor Hill Station (1,080m elevation)"
  - icon: "🚲"
    label: "Getting Around"
    value: "Bicycle or scooter — town is small"
  - icon: "🏧"
    label: "ATMs"
    value: "Available on main street (ABA, ACLEDA)"
  - icon: "🌅"
    label: "Must Do"
    value: "Sunset river cruise ($5)"
  - icon: "⏱️"
    label: "Ideal Stay"
    value: "3-4 days"
highlights:
  - "Kampot pepper plantation tours"
  - "Bokor Hill Station and abandoned palace"
  - "Sunset river cruise on the Praek Tuek Chhu"
  - "Riverside cafe culture"
  - "Cave temples at Phnom Chhnork"
  - "Crab market seafood"
...
relatedDestinations:
  ...
  - "phnom-penh"
faqItems:
  - question: "What is so special about Kampot pepper?"
    answer: "Kampot pepper is considered among the finest in the world and holds a geographical indication (GI) status — think Champagne for pepper. The volcanic soil and climate of Kampot province produce peppercorns with a complex flavor profile that chefs compare to fine wine: fruity, floral, and intensely aromatic. The fresh green peppercorns, eaten straight from the vine, have a heat and fragrance that bears no resemblance to the dried powder in your kitchen. Plantation tours ($5-10) let you taste the difference yourself."
  - question: "Is Kampot worth visiting or should I just go to Kep?"
    answer: "Both, ideally. Kampot and Kep are only 25 minutes apart and complement each other perfectly. Kampot offers the riverside cafe scene, nightlife, pepper plantations, and Bokor Hill Station. Kep delivers the seafood, national park hikes, and Rabbit Island beach. Most travelers base themselves in Kampot (more accommodation and restaurant options) and day trip to Kep. But staying in both gives you the full south coast experience."
  - question: "How do I visit Bokor Hill Station?"
    answer: "Bokor Hill Station is 42 km from Kampot town, reached by a winding mountain road. Rent a motorbike ($7-10/day) for the self-guided experience — the road is paved and in good condition but has steep sections and hairpin turns. Alternatively, hire a tuk-tuk for a half day ($25-30) or join a guided tour ($15-25). The abandoned French hill station, the Popokvil waterfall, and the Lok Yeay Mao statue at the summit are the main stops. Go early to avoid clouds that roll in by midday."
  - question: "What is the nightlife like in Kampot?"
...
affiliatePicks:
  ...
  - name: "Kampot Pepper Plantation Tour"
    type: "tour"
    price: "$10-20"
    personalNote: "Visited La Plantation — a 20-minute drive from town — and spent two hours learning how pepper is grown, harvested, and dried. The tasting of fresh green, black, red, and white peppercorns directly changed how I cook at home. Bought a kilo to take home."
    affiliateUrl: "https://www.getyourguide.com/kampot?partner_id=IVN6IQ3"
  - name: "Sunset River Cruise"
    type: "activity"
    price: "$5-8"
    personalNote: "A ninety-minute cruise up the Praek Tuek Chhu River past mangroves, fishing villages, and firefly trees. The sunset reflecting off the water while the boat drifts in silence is my single favorite moment on the Cambodian south coast."
    affiliateUrl: "https://www.viator.com/kampot?pid=P00290009"
  - name: "Bokor Hill Station Day Trip"
    type: "tour"
    price: "$20-30"
    personalNote: "The abandoned French colonial buildings at the summit are hauntingly photogenic, and the views over the Gulf of Thailand on a clear day stretch to Phu Quoc Island in Vietnam. The temperature drops noticeably — a welcome relief from the coastal heat."
    affiliateUrl: "https://www.getyourguide.com/kampot?partner_id=IVN6IQ3"
