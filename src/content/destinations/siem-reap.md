...
essentials:
  - icon: "🌡️"
    label: "Climate"
    value: "Tropical, 24-36°C, dry season Nov-Apr"
  - icon: "💵"
    label: "Currency"
    value: "USD primary, Riel for small change"
  - icon: "🎫"
    label: "Angkor Pass"
    value: "1-day $37, 3-day $62, 7-day $72"
  - icon: "🚲"
    label: "Getting Around"
    value: "Tuk-tuk $15-20/day, bicycle $3-5/day"
  - icon: "📶"
    label: "WiFi"
    value: "Good in town, limited at temples"
  - icon: "🏧"
    label: "ATMs"
    value: "Plentiful on Pub Street and airport"
  - icon: "⏰"
    label: "Temple Hours"
    value: "5:00 AM - 5:30 PM daily"
  - icon: "👔"
    label: "Dress Code"
    value: "Knees and shoulders covered at temples"
highlights:
  - "Angkor Wat sunrise"
  - "Bayon's stone faces at Angkor Thom"
  - "Ta Prohm — the 'Tomb Raider' temple"
  - "Banteay Srei's pink sandstone carvings"
...
faqItems:
  - question: "How many days do I need for Angkor Wat and Siem Reap?"
    answer: "Three days is the sweet spot. Day one: the big circuit (Angkor Wat sunrise, Angkor Thom, Bayon, Ta Prohm). Day two: the outer temples (Banteay Srei, Beng Mealea, Pre Rup for sunset). Day three: revisit favorites in the morning and enjoy Siem Reap town — markets, cooking class, Phare Circus. A one-day pass works if time is tight, but you will feel rushed."
  - question: "Is the 3-day or 7-day Angkor Pass worth it?"
    answer: "The 3-day pass ($62) is the best value for most travelers. It is valid for any 3 days within a 10-day window, so you can take rest days between temple visits. The 7-day pass ($72) is only worth it for archaeology enthusiasts or photographers who want repeat sunrise/sunset visits. The 1-day pass ($37) works but forces you to rush through sites that deserve contemplation."
  - question: "What is the best time to see Angkor Wat sunrise?"
    answer: "Arrive at Angkor Wat by 5:15 AM. Position yourself at the left reflecting pool (north side) for the classic silhouette reflection shot. The actual sunrise happens between 5:45-6:15 AM depending on the season. December-February offers the most reliable clear skies. After the sunrise crowd thins around 7:00 AM, enter the temple itself — most people leave and you will have the inner galleries almost to yourself."
  - question: "Is Pub Street worth visiting or is it a tourist trap?"
    answer: "Pub Street is unapologetically touristy — $0.50 draft beers, fish massage parlors, and thumping music. But dismissing it entirely means missing the night market behind it (great for souvenirs), the side alleys with excellent Khmer restaurants, and the raw fun of watching a bucket of cocktails disappear among new friends. Go once, enjoy it for what it is, then explore the quieter streets nearby."
  - question: "Should I hire a guide for the Angkor temples?"
...
affiliatePicks:
  ...
  - name: "Angkor Wat Sunrise Small Group Tour"
    type: "tour"
    price: "$18-35"
    personalNote: "A guided small-group tour with hotel pickup at 4:45 AM, sunrise at Angkor Wat, then Bayon and Ta Prohm by mid-morning before the heat and crowds peak. The guide I had knew hidden corridors at Ta Prohm that the big groups skip entirely."
    affiliateUrl: "https://www.getyourguide.com/siem-reap?partner_id=IVN6IQ3"
  - name: "Phare Cambodian Circus Tickets"
    type: "activity"
    price: "$18-38"
    personalNote: "The absolute best evening activity in Siem Reap, no contest. Cambodian youth performers tell stories through acrobatics, theater, and live music. I have seen three shows and teared up at every one. Book the A-section seats for $28 — worth the upgrade."
    affiliateUrl: "https://www.viator.com/siem-reap?pid=P00290009"
  - name: "Tonle Sap Floating Village Tour"
    type: "tour"
    price: "$25-40"
    personalNote: "Skip the touristy Chong Khneas and book a tour to Kompong Khleang instead — it is the real deal. An entire community living on the water with a school, shops, and a pagoda. The boat ride through flooded forest in wet season is ethereal."
    affiliateUrl: "https://www.getyourguide.com/siem-reap?partner_id=IVN6IQ3"
  - name: "Cambodian Cooking Class"
    type: "activity"
    price: "$15-25"
    personalNote: "Start at the morning market picking ingredients, then learn to cook fish amok, green mango salad, and banana flower soup. My class was at a family home outside the city, which made it infinitely more personal than the hotel-based versions."
    affiliateUrl: "https://www.viator.com/siem-reap?pid=P00290009"
...
- **Getting There:** Siem Reap International Airport (REP) is 8 km from town center. Official taxis ($10) and tuk-tuks ($7) wait outside arrivals. Use Grab for transparent pricing ($5-7). From Phnom Penh, Giant Ibis bus ($15, 6 hours) is the most comfortable option with free WiFi, snacks, and USB charging. From Bangkok, direct flights (1.5 hours, $60-120) or overland via Poipet border crossing (bus + border + bus, 8-10 hours total, not recommended for first-timers).
...
- **Getting Around:** Hire a tuk-tuk driver for the day ($15-20 for the small circuit, $25-30 for the big circuit or outer temples). Many drivers speak excellent English and serve as informal guides. For independent exploration, rent a bicycle ($3-5/day) — the roads within the Angkor complex are flat and shaded. Electric bikes ($10-15/day) are increasingly popular. In town, everything is walkable or a $2 tuk-tuk ride.

- **Money & ATMs:** ATMs line Pub Street and Sivutha Boulevard, dispensing USD with $4-5 fees per withdrawal. ABA Bank and Canadia Bank are the most reliable. Bring crisp US bills — damaged or pre-2006 notes may be refused. Most restaurants and hotels accept credit cards with a 2-3% surcharge. The Angkor Pass can be purchased with credit card at the ticket office. Budget $37-72 for temple passes plus $15-20/day for tuk-tuk transport within the park.

- **Safety & Health:** Siem Reap is very safe. The main risks are dehydration (bring 3+ liters of water per temple day), sunburn (wear a hat and reapply sunscreen), and twisted ankles on uneven temple stairs. Watch for the well-meaning children selling postcards and bracelets at temples — buying from them encourages families to keep children out of school. If you want to help, donate to established organizations like Phare or Friends. For medical care, Royal Angkor International Hospital is the best-equipped facility.

- **Packing Essentials:** Clothing that covers knees and shoulders (enforced at temples — you will be turned away). Comfortable shoes with grip for climbing steep temple stairs. A headlamp or phone flashlight for pre-dawn temple arrivals. A refillable water bottle. Sunscreen and a wide-brimmed hat. A lightweight rain jacket in wet season. Mosquito repellent for sunset temple visits.

- **Local Culture & Etiquette:** Never climb on temple structures not designated for climbing. Do not touch or sit on Buddha statues. Ask before photographing monks. When monks walk past, step aside — they have the right of way on temple pathways. Offer a sampeah (palms together, slight bow) when greeting Cambodians. At restaurants, leaving a 10% tip is generous but not expected. Learn "awkun" (thank you) and "soksabai" (how are you) — Cambodians light up when visitors try Khmer phrases.
