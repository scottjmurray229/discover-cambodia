...
budgetPerDay:
  ...
  midRange: 40
  luxury: 100
gettingThere: "Tonle Sap is accessed from Siem Reap (30-90 minutes depending on which village). Tours depart daily from Siem Reap. The lake is also accessible from Battambang via the Sangker River boat."
essentials:
  - icon: "🌡️"
    label: "Climate"
    value: "Tropical, 27-35°C, distinct wet/dry seasons"
  - icon: "💵"
    label: "Currency"
    value: "USD — bring cash, no ATMs on the lake"
  - icon: "🏘️"
    label: "Famous For"
    value: "Floating and stilted villages"
  - icon: "🐦"
    label: "Birdwatching"
    value: "Prek Toal Bird Sanctuary — 150+ species"
  - icon: "🌊"
    label: "Seasonal Flooding"
    value: "Lake expands 5x in wet season (Jun-Oct)"
  - icon: "📶"
    label: "WiFi"
    value: "None on the lake — bring offline entertainment"
  - icon: "⛴️"
    label: "Access"
    value: "Boat tours from Siem Reap, 30-90 min"
  - icon: "⏱️"
    label: "Ideal Visit"
    value: "Half day to full day from Siem Reap"
highlights:
  - "Kompong Khleang — authentic stilted village"
...
relatedDestinations:
  ...
  - "phnom-penh"
faqItems:
  - question: "Which floating village on Tonle Sap should I visit?"
    answer: "Kompong Khleang is my top recommendation — it is the largest and most authentic stilted village on the lake, with a real community of 10,000+ people living on or above the water. It is farther from Siem Reap (90 minutes) but far less touristy than Chong Khneas (30 minutes). Mechrey is a good middle option — smaller, quieter, and combined with excellent birdwatching at Prek Toal. Avoid Chong Khneas unless you have very limited time — it has become heavily commercialized."
  - question: "What is the best time to visit Tonle Sap?"
    answer: "The lake is fascinating year-round but looks dramatically different by season. September through November (late wet season) is the most spectacular — the lake has expanded to its maximum size, the water level rises 8-10 meters, and the flooded forests are navigable by boat. The stilted houses are surrounded by water up to their floors. December through February is comfortable and dry. March through May (late dry season) reveals a shrunken lake surrounded by mud flats — less scenic but interesting for understanding the scale of seasonal change."
  - question: "Is the Tonle Sap floating village tour a tourist trap?"
    answer: "Some tours are, particularly the cheapest Chong Khneas boat trips that rush you through and deposit you at floating souvenir shops. The key is choosing the right village and the right operator. Kompong Khleang and Mechrey offer genuine community experiences with less commercialization. Book through a reputable Siem Reap operator ($25-40) rather than the cheapest tuk-tuk driver deal. The extra cost goes to better boats, knowledgeable guides, and community contributions."
  - question: "How does the Tonle Sap seasonal flooding work?"
...
affiliatePicks:
  - name: "Kompong Khleang Village Tour"
    type: "tour"
    price: "$30-45"
    personalNote: "The most authentic Tonle Sap experience available. A 90-minute drive from Siem Reap followed by a boat tour through a genuine community of thousands living above the water. My guide grew up in the village and introduced me to fishermen, teachers, and the owner of the floating convenience store. This tour changed my understanding of how water shapes human life."
    affiliateUrl: "https://www.getyourguide.com/siem-reap?partner_id=IVN6IQ3"
    badge: "Must Do"
  - name: "Prek Toal Birdwatching Tour"
    type: "tour"
    price: "$35-60"
    personalNote: "An early-morning boat ride through flooded forest to a viewing platform where rare waterbirds nest in the treetops. I saw milky storks, painted storks, pelicans, and a greater adjutant from 15 meters away. The boat ride through the drowned forest was as memorable as the birds themselves."
    affiliateUrl: "https://www.viator.com/siem-reap?pid=P00290009"
  - name: "Mechrey Floating Village & Sunset Tour"
    type: "tour"
    price: "$25-35"
    personalNote: "A smaller, quieter floating village combined with a sunset boat ride on the open lake. The golden light on the water, the silhouettes of fishing boats, and the absolute stillness of the lake at dusk created one of my favorite memories in Cambodia."
    affiliateUrl: "https://www.getyourguide.com/siem-reap?partner_id=IVN6IQ3"
  - name: "Sangker River Boat Siem Reap to Battambang"
    type: "transport"
    price: "$20"
    personalNote: "While not strictly a Tonle Sap tour, this boat journey begins on the lake and navigates up the Sangker River to Battambang through flooded forest and river villages. It is 6-8 hours of pure Cambodia — one of the most scenic boat rides in Southeast Asia."
    affiliateUrl: "https://www.viator.com/siem-reap?pid=P00290009"
...
### Packed Lunch (recommended for full-day tours)
