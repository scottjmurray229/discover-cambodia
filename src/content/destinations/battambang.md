...
budgetPerDay:
  ...
  midRange: 40
  luxury: 120
gettingThere: "Buses from Siem Reap (3-4 hours, $5-8) or Phnom Penh (5-6 hours, $8-12). The scenic boat trip from Siem Reap via the Sangker River operates in wet season (September-February, $20, 6-8 hours)."
essentials:
  - icon: "🌡️"
    label: "Climate"
    value: "Tropical, 25-35°C, dry Nov-Apr"
  - icon: "💵"
    label: "Currency"
    value: "USD accepted, Riel more common than cities"
  - icon: "🎪"
    label: "Must-See"
    value: "Phare Ponleu Selpak (Phare Circus birthplace)"
  - icon: "🚂"
    label: "Famous For"
    value: "Bamboo train (Norry)"
  - icon: "🚲"
    label: "Best Transport"
    value: "Bicycle — the town is flat and compact"
  - icon: "🏧"
    label: "ATMs"
    value: "Available on main streets (ABA, ACLEDA)"
  - icon: "🦇"
    label: "Bat Caves"
    value: "Millions emerge at sunset at Phnom Sampeau"
  - icon: "⏱️"
    label: "Ideal Stay"
    value: "2-3 days"
highlights:
  - "Bamboo train (Norry) ride"
  - "Phare Ponleu Selpak campus"
  - "Phnom Sampeau bat exodus at sunset"
  - "Colonial French architecture walk"
...
relatedDestinations:
  ...
  - "tonle-sap"
faqItems:
  - question: "Is the bamboo train still running in Battambang?"
    answer: "Yes, though it has been relocated and rebuilt as a more tourist-oriented attraction. The original bamboo train operated on the old French colonial railway line and was genuinely used by locals — that version no longer exists. The current version ($5 per person) runs on a shorter track and is essentially a tourist ride, but the experience of gliding through rice paddies on a bamboo platform powered by a small engine is still unique and entertaining. Just adjust your expectations accordingly."
  - question: "How do I get from Siem Reap to Battambang by boat?"
    answer: "The Sangker River boat is one of Cambodia's most scenic journeys but only operates when water levels permit (typically September through February, sometimes into March). The trip takes 6-8 hours and costs around $20. You navigate through narrow river channels, flooded forests, and past riverside villages where children wave from stilted houses. Buy tickets through your hotel in Siem Reap. Be warned: the boat has minimal shade and the wooden seats are not comfortable — bring a cushion, sunscreen, and snacks."
  - question: "What makes Battambang worth visiting?"
    answer: "Battambang offers the most authentic slice of provincial Cambodian life accessible to tourists. The colonial architecture is better preserved than Phnom Penh's, the food is considered the best in Cambodia (especially the oranges and rice), the art and circus scene is genuinely world-class thanks to Phare, and the surrounding countryside — rice paddies, pagodas, bat caves, hilltop temples — rewards slow exploration by bicycle. It is the antidote to temple fatigue after Siem Reap."
  - question: "Is Battambang worth visiting for just one day?"
...
affiliatePicks:
  ...
  - name: "Battambang Countryside Cycling Tour"
    type: "tour"
    price: "$20-30"
    personalNote: "A full day on two wheels through rice paddies, past pagodas, to the bamboo train, and ending at Phnom Sampeau for the sunset bat exodus. My guide grew up in the villages we cycled through and introduced me to his grandmother, who made us lemongrass tea."
    affiliateUrl: "https://www.getyourguide.com/battambang?partner_id=IVN6IQ3"
  - name: "Phare Ponleu Selpak Show"
    type: "activity"
    price: "$8-14"
    personalNote: "The original Phare campus in Battambang where it all began. The shows are more intimate than Siem Reap and you can tour the school grounds afterward. Seeing the students practicing acrobatics in the yard is as moving as the performance itself."
    affiliateUrl: "https://www.viator.com/battambang?pid=P00290009"
  - name: "Sangker River Boat Trip"
    type: "activity"
    price: "$20"
    personalNote: "One of the most memorable journeys in Cambodia. Six hours on the water between Siem Reap and Battambang through flooded forests and tiny river villages. Bring a cushion, sunscreen, and zero expectations of luxury."
    affiliateUrl: "https://www.viator.com/battambang?pid=P00290009"
...
<div class="immersive-break-inline" id="arrival">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">French colonial shophouses, a bamboo railway, temples on hillsides above the plain, and the most vibrant arts scene in Cambodia — Battambang whispers where Phnom Penh shouts.</p>
  </div>
</div>
...
<div class="immersive-break-inline" id="explore">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">The Bamboo Railway, Phare Circus rehearsals, Banan Temple on its hilltop, the Killing Caves of Phnom Sampeau, and a colonial town center with the finest vintage shophouses in Cambodia.</p>
  </div>
</div>
...
<div class="immersive-break-inline" id="stay">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">Colonial guesthouses on the riverside, boutique hotels in the old town, and a price range that makes staying three nights instead of two an easy decision.</p>
  </div>
</div>
...
<div class="immersive-break-inline" id="essentials">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">Book the bamboo railway in the morning, visit the Killing Caves at Phnom Sampeau at sunset for the bat emergence, and allow at least two full days for a town that consistently overdelivers.</p>
  </div>
</div>

## Scott's Pro Tips

- **Getting There:** From Siem Reap, buses take 3-4 hours ($5-8). The Sangker River boat ($20, 6-8 hours, wet season only September-February) is infinitely more scenic and one of my top Cambodia recommendations. From Phnom Penh, direct buses take 5-6 hours ($8-12). The new road is in good condition. Capitol Bus and Sorya Transport both run the route.
...
- **Getting Around:** Battambang is flat and compact — a bicycle is the ideal transport. Most guesthouses offer free bikes or rent them for $1-3 per day. For the countryside circuit (bat caves, bamboo train, Ek Phnom), hire a tuk-tuk for a half day ($10-15). Walking the town center takes about 30 minutes end to end.

- **Money & ATMs:** ATMs are available on the main streets (ABA and ACLEDA banks). Battambang is more cash-dependent than Siem Reap or Phnom Penh — many restaurants and guesthouses accept only cash. Withdraw enough for your stay plus a buffer. Riel is used more commonly here for small purchases than in the big cities.

- **Safety & Health:** Battambang is one of the safest towns in Cambodia. The main risk is cycling accidents on unpaved rural roads — go slowly and watch for dogs. Tap water is not drinkable. The provincial hospital is basic — for serious medical issues, Siem Reap (3 hours) or Phnom Penh (5 hours) have better facilities. Carry basic first aid supplies for countryside excursions.

- **Packing Essentials:** Comfortable cycling clothes and shoes. Sunscreen and a hat for the flat, shadeless countryside. A lightweight rain jacket in wet season. Insect repellent for evening bat cave visits. A reusable water bottle. A small flashlight for exploring cave temples.

- **Local Culture & Etiquette:** Battambang is more traditional than Phnom Penh or Siem Reap. Dress modestly when visiting pagodas — shoulders and knees covered. When cycling through villages, slow down near schools and pagodas. Greeting people with "susadei" earns warm smiles. Battambang residents are proud of their province's food — complimenting the oranges or the rice is a genuine conversation starter.
