...
essentials:
  - icon: "🌡️"
    label: "Climate"
    value: "Tropical coastal, 26-33°C year-round"
  - icon: "💵"
    label: "Currency"
    value: "USD accepted, Riel for small purchases"
  - icon: "🦀"
    label: "Famous For"
    value: "Crab market — freshest seafood in Cambodia"
  - icon: "🏝️"
    label: "Day Trip"
    value: "Rabbit Island (Koh Tonsay) — $7 return boat"
  - icon: "🌲"
    label: "National Park"
    value: "Kep National Park — 8 km jungle trails"
  - icon: "🏧"
    label: "ATMs"
    value: "Limited — bring cash from Kampot or Phnom Penh"
  - icon: "🏚️"
    label: "Hidden Gem"
    value: "Abandoned French villas in the jungle"
  - icon: "⏱️"
    label: "Ideal Stay"
    value: "2-3 days"
highlights:
  - "Crab market fresh seafood feast"
  - "Rabbit Island (Koh Tonsay) beach day"
  - "Kep National Park jungle trails"
  - "Abandoned French colonial villas"
  - "Pepper farm tours"
...
relatedDestinations:
  ...
  - "koh-rong"
faqItems:
  - question: "What makes Kep's crab market so special?"
    answer: "The crab market is a strip of seafood restaurants on stilts over the water where fishermen sell their catch directly to the kitchens. You point at the crab, prawns, or fish you want, and it is cooked to order — grilled, fried, or stir-fried with kampot pepper. The signature dish is Kep crab with green kampot pepper, which costs $6-10 for a whole crab. The freshness is the difference — this crab was in the ocean hours ago, and you taste it."
  - question: "Is Rabbit Island worth the trip?"
    answer: "Yes, for a relaxed beach day. Koh Tonsay (Rabbit Island) is a 25-minute boat ride from Kep pier ($7-10 return). The main beach is a crescent of sand with basic beach shacks serving fried fish and cold beer. There are no roads, no cars, and no WiFi worth mentioning. Hammocks, swimming, and enforced digital detox is the entire agenda. Overnight stays in basic bungalows ($5-10) are available for those who want to hear the waves at night."
  - question: "How long should I spend in Kep?"
    answer: "Two days is sufficient for most travelers — one day for the crab market, national park, and abandoned villas, and one day for Rabbit Island. Three days allows a more relaxed pace with time for pepper plantation visits (shared with Kampot), kayaking, and repeat crab market visits. Kep works best as part of a south coast circuit with Kampot (25 minutes away), where there are more accommodation and nightlife options."
  - question: "Are the abandoned villas safe to explore?"
...
affiliatePicks:
  ...
  - name: "Rabbit Island Day Trip"
    type: "activity"
    price: "$7-10"
    personalNote: "A 25-minute boat ride to a car-free island with one beach, a handful of shacks, and absolutely nothing to do except swim, eat fried fish, and lie in a hammock. Sometimes the best activities are the ones with no agenda."
    affiliateUrl: "https://www.viator.com/kep?pid=P00290009"
  - name: "Kep Pepper Farm Tour"
    type: "tour"
    price: "$8-15"
    personalNote: "Smaller and more intimate than the Kampot plantations. The farmer walked me through the growing process, explained the harvest timing for different pepper varieties, and let me eat fresh peppercorns off the vine. Left with a bag of smoked kampot pepper I have never seen elsewhere."
    affiliateUrl: "https://www.getyourguide.com/kep?partner_id=IVN6IQ3"
