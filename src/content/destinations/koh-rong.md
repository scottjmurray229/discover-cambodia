...
budgetPerDay:
  ...
  midRange: 60
  luxury: 200
gettingThere: "Speed ferries from Sihanoukville (45 minutes, $12-15 one way) depart from Serendipity Pier. Slow boats (2.5 hours, $7-8) are cheaper. Buy tickets at the pier or online through Speed Ferry Cambodia or Buva Sea."
essentials:
  - icon: "🌡️"
    label: "Climate"
    value: "Tropical island, 27-33°C, wet season Jun-Oct"
  - icon: "💵"
    label: "Currency"
    value: "USD cash — no ATMs on the island"
  - icon: "🏖️"
    label: "Best Beach"
    value: "Long Set Beach — 7 km of white sand"
  - icon: "🌌"
    label: "Must-See"
    value: "Bioluminescent plankton at night"
  - icon: "📶"
    label: "WiFi"
    value: "Patchy — works at some guesthouses, don't rely on it"
  - icon: "🏧"
    label: "ATMs"
    value: "NONE — bring enough cash for your entire stay"
  - icon: "⛴️"
    label: "Ferry"
    value: "45 min speed ferry from Sihanoukville ($12-15)"
  - icon: "⏱️"
    label: "Ideal Stay"
    value: "3-5 days"
highlights:
  - "Long Set Beach — 7 km of paradise"
  - "Bioluminescent plankton night swimming"
  - "Jungle trek across the island"
  - "Diving and snorkeling"
  - "Koh Rong Sanloem day trip"
...
relatedDestinations:
  ...
  - "kampot"
faqItems:
  - question: "What is the difference between Koh Rong and Koh Rong Sanloem?"
    answer: "Koh Rong is larger, more developed, and has a party scene centered around Koh Tuch village near the ferry pier. Long Set Beach on the other side of the island is quieter and more beautiful. Koh Rong Sanloem is smaller, quieter overall, and attracts travelers seeking tranquility — Saracen Bay is its main beach with mid-range bungalows and a peaceful atmosphere. Choose Koh Rong if you want both party and paradise (just stay at Long Set Beach). Choose Koh Rong Sanloem if you want pure relaxation."
  - question: "Do I need to bring cash to Koh Rong?"
    answer: "Yes, absolutely. There are no ATMs on Koh Rong. Some upscale resorts accept credit cards (with surcharges), but guesthouses, restaurants, dive shops, and boat operators are cash only. Bring enough USD for your entire stay plus a contingency buffer. I recommend $30-50 per day for budget travelers and $80-120 for mid-range, in a mix of small bills ($1, $5, $10)."
  - question: "Is Koh Rong safe?"
    answer: "The island is generally safe. The main risks are strong currents on certain beaches (ask locally before swimming), sand fly bites (use repellent, especially at dawn and dusk), and limited medical facilities — the island has a basic clinic but serious injuries require evacuation to Sihanoukville by boat. Do not leave valuables unattended on the beach. The party scene at Koh Tuch can get rowdy late at night but is not dangerous."
  - question: "When can I see the bioluminescent plankton?"
    answer: "The bioluminescent plankton are visible year-round but are best seen on moonless or new moon nights between June and November. Walk to a dark section of beach away from light pollution (Long Set Beach is ideal), wade into the water, and move your hands — the water erupts in electric blue light. It is caused by dinoflagellates that glow when disturbed. The darker the night, the more spectacular the display. Guided night tours ($10-15) take you to the best spots."
  - question: "How is the diving around Koh Rong?"
...
affiliatePicks:
  - name: "Song Saa Private Island"
    ...
    personalNote: "Cambodia's only luxury private island resort, built across two tiny islands near Koh Rong with overwater villas, a marine conservation program, and the kind of remote beauty that justifies the price tag for special occasions. I have not stayed here — but I have gazed at it longingly from a kayak."
    affiliateUrl: "https://www.agoda.com/partners/partnersearch.aspx?pcs=1&cid=1959462&hl=en-us&textToSearch=koh%20rong"
  - name: "The One Resort Long Set Beach"
    type: "hotel"
    price: "$40-80/night"
    personalNote: "My base on Koh Rong — beachfront bungalows on Long Set Beach with air conditioning, hot water, and a restaurant that serves surprisingly good Khmer food. Falling asleep to the sound of waves on what might be the most beautiful beach in Cambodia is an experience I chase constantly."
    affiliateUrl: "https://www.agoda.com/partners/partnersearch.aspx?pcs=1&cid=1959462&hl=en-us&textToSearch=koh%20rong%20long%20set"
    badge: "Where I Stay"
  - name: "Koh Rong Diving PADI Course"
    type: "activity"
    price: "$60-350"
    personalNote: "Did a Discover Scuba dive ($65) and saw seahorses, nudibranchs, and a ray within the first dive. The instructors were patient and professional. The value compared to Thai island dive shops is remarkable."
    affiliateUrl: "https://www.viator.com/koh-rong?pid=P00290009"
  - name: "Bioluminescent Plankton Night Tour"
    type: "activity"
    price: "$10-15"
    personalNote: "A guided walk to the darkest section of beach followed by wading into water that lights up electric blue with every movement. One of the most magical natural phenomena I have witnessed. Go on a new moon night for the best display."
    affiliateUrl: "https://www.viator.com/koh-rong?pid=P00290009"
