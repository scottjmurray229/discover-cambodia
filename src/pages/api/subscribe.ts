...
const GUIDE_NAMES: Record<string, string> = {
  'destination-phnom-penh': 'Phnom Penh Travel Guide',
  'destination-siem-reap': 'Siem Reap Travel Guide',
  'destination-sihanoukville': 'Sihanoukville Travel Guide',
  'destination-battambang': 'Battambang Travel Guide',
  'destination-kampot': 'Kampot Travel Guide',
  'destination-kep': 'Kep Travel Guide',
  'destination-koh-rong': 'Koh Rong Travel Guide',
  'destination-kratie': 'Kratie Travel Guide',
  'destination-mondulkiri': 'Mondulkiri Travel Guide',
  'destination-tonle-sap': 'Tonle Sap Travel Guide',
};
  ...
  <div style="max-width:560px;margin:0 auto;padding:40px 24px;">
    <div style="background:white;border-radius:16px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
      <div style="background:linear-gradient(135deg,#0D7377,#14B8A6);padding:32px 28px;text-align:center;">
        <h1 style="color:white;font-size:24px;margin:0 0 8px;">Discover Cambodia</h1>
      ...
      <div style="padding:28px;">
        <p style="color:#1A2332;font-size:16px;line-height:1.65;margin:0 0 16px;">
          Welcome! You're now part of the Discover Cambodia community.
        </p>
        ...
        <div style="text-align:center;margin-bottom:24px;">
          <a href="https://discovercambodia.info/destinations/" style="display:inline-block;background:#0D7377;color:white;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:600;font-size:15px;">Browse All Destinations</a>
        </div>
    ...
    <p style="color:#94A3B8;font-size:11px;text-align:center;margin:20px 0 0;line-height:1.5;">
      You're receiving this because you signed up at discovercambodia.info.<br>
      <a href="https://discovercambodia.info/legal/privacy/" style="color:#94A3B8;">Privacy Policy</a>
    </p>
  </div>
</body>
</html>`;
...
async function sendWelcomeEmail(apiKey: string, to: string, guideName: string): Promise<void> {
  const res = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      ...
      to: [to],
      subject: `Your ${guideName} — Welcome to Discover Cambodia`,
